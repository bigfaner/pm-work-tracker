...
// Computed fields (MilestoneCount, OverallProgress) are populated by the service layer.
...
// Computed fields (Completion, ItemCount) are populated by the service layer.
