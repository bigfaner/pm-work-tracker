...
var acceptedFields = map[string]map[string]bool{
	model.MainItem{}.TableName():     {"title": true, "priority": true, "item_status": true, "assignee_key": true, "completion_pct": true, "actual_end_date": true, "archived_at": true, "item_desc": true, "is_key_item": true, "plan_start_date": true, "expected_end_date": true, "milestone_key": true},
	...
	model.MilestoneMap{}.TableName(): {"map_name": true, "map_desc": true, "map_status": true},
	model.Milestone{}.TableName():    {"milestone_name": true, "expected_end_date": true, "milestone_status": true},
}
