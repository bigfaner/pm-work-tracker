...
CREATE TABLE IF NOT EXISTS pmw_milestone_maps (
    ...
    map_desc        TEXT,                              -- 里程碑图描述
    map_status      VARCHAR(20)   NOT NULL DEFAULT 'planning' -- 状态：planning=规划中，reviewed=已评审，ready=待实施，executing=实施中，completed=已完成
);
