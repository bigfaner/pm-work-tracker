...
- Type: UI / API / CLI
- Target: Test target path (e.g., api/permission-matrix)
...
- [ ] All test cases traceable to PRD acceptance criteria (Stories 1–5)
- [ ] Test cases grouped by type (API)
...
3. All tests in this feature are API type (no UI, no CLI)
