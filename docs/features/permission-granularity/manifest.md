...
|-------------|----------------|--------------|-------|
| 权限码注册表变更 | tech-design §Interfaces 1 | — | — |
| 路由中间件绑定 | tech-design §Interfaces 2 + api-handbook | — | — |
| 预置角色权限调整 | tech-design §Interfaces 4 | — | — |
| 数据迁移（两步上线） | tech-design §Interfaces 3 | — | — |
| 角色下拉选择器 | tech-design §Interfaces 8 | TeamManagementPage | — |
| 用户管理页入口 | tech-design §Interfaces 6+7 | App.tsx + Sidebar.tsx | — |
| 角色管理页按钮 | tech-design §Interfaces 5+6 | RoleManagementPage | — |
