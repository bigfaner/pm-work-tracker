...
Read each record file from `docs/features/bizkey-unification/tasks/records/` whose filename starts with `2.` and does NOT contain `.summary`.
...
- All phase 2 task records: `docs/features/bizkey-unification/tasks/records/2.*.md`
- Design reference: `docs/features/bizkey-unification/design/tech-design.md`
