...
- Type: UI / API / CLI
- Target: Test target path (e.g., api/item-lifecycle, api/item-pool)
...
3. This feature is backend-only (Go integration + unit tests), so all test cases will be API type
