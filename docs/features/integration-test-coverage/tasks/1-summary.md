...
Read each record file from `docs/features/integration-test-coverage/tasks/records/` whose filename starts with `1.` and does NOT contain `.summary`.
...
- All phase task records: `docs/features/integration-test-coverage/tasks/records/1.*.md`
