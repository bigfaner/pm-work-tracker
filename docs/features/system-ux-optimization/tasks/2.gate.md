...
- Design: `docs/features/system-ux-optimization/design/tech-design.md`
- This phase's task records: `docs/features/system-ux-optimization/tasks/records/2.*.md`
- This phase's summary: `docs/features/system-ux-optimization/tasks/records/2-summary.md`
