...
Generate test Contract specifications for the system-ux-optimization feature.
Mode: breakdown
...
2. **Read Journeys**: Enumerate Journey directories under `docs/features/system-ux-optimization/testing/` and read each `journey.md`
...
6. **Write Output**: Write Contract files to `docs/features/system-ux-optimization/testing/<journey>/contracts/` and Fact Table to `.forge/fact-table.json`
