...
| Claim | Source | Type |
|---|---|---|
| Empty filter results show message with clear action | prd-spec empty state handling | explicit |
...
- Preconditions: "The user's session has expired while the filter controls are displayed"
