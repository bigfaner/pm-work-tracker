...
| 用户名 | 显示名 | 邮箱 | 状态 | 所属团队 | 操作 |
|--------|--------|------|------|----------|------|
| alice | Alice Wang | alice@co.com | 启用 | 产品团队 | 编辑 / 重置密码 / 删除 |
| bob | Bob Li | bob@co.com | 禁用 | — | 编辑 / 重置密码 / 删除 |
| carol | Carol Zhang | carol@co.com | 启用 | 研发团队 | 编辑 / 重置密码 / 删除（自身账号禁用） |
