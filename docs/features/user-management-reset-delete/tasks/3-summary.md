...
Generate a structured summary of all completed tasks in this phase. This summary is read by subsequent tasks (test generation) to maintain consistency.

## Instructions

### Step 1: Read all phase task records

Read each record file from `docs/features/user-management-reset-delete/tasks/records/` whose filename starts with `3.` and does NOT contain `.summary`.
...
- All phase task records: `docs/features/user-management-reset-delete/tasks/records/3.*.md`
- Design reference: `docs/features/user-management-reset-delete/design/tech-design.md`
