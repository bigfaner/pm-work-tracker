...
Read each record file from `docs/features/user-management-reset-delete/tasks/records/` whose filename starts with `1.` and does NOT contain `.summary` (e.g., `1.1-*.md`, `1.2-*.md`).
...
- All phase task records: `docs/features/user-management-reset-delete/tasks/records/1.*.md`
