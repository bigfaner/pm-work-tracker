...
Read each record file from `docs/features/user-management-reset-delete/tasks/records/` whose filename starts with `2.` and does NOT contain `.summary`.
...
- All phase task records: `docs/features/user-management-reset-delete/tasks/records/2.*.md`
