...
Evaluate Journey quality for the milestone-map feature using the 6-dimension rubric (1000-point scale).
...
## Discovery Strategy
Scan `docs/features/milestone-map/testing/journeys/` for all Journey files listed in `manifest.md`.
