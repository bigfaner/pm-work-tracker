---
id: "fix-7"
title: "E2E: milestone-item-management 3 remaining failures"
priority: "P0"
...
# E2E: milestone-item-management 3 remaining failures

## Root Cause

3 tests fail: (1) step3-unbind TC-MIM-S3-002 expects undo info but toast has no clickable undo. (2) step5-navigate-drag TC-MIM-S6-001 drag-drop rebinding. (3) step5-navigate-drag TC-MIM-S7-001 delete hidden for in_progress milestone. Read MilestoneTimeline.tsx and MilestoneDetailPanel.tsx for actual UI.
