...
import { curl, apiBaseUrl, randomCode, authHeader, getApiToken, parseApiBody, createTestTeam, createTestMainItem, createTestSubItem } from '../../shared/helpers.js';
...
describe('Soft-Delete — Items (TC-003, TC-004)', () => {
  beforeAll(async () => {
