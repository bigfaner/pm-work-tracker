...
import { curl, apiBaseUrl, getApiToken, createAuthCurl, defaultCreds, randomCode, setupRbacFixtures } from '../../shared/helpers.js';
...
describe('RBAC — Items (TC-001, TC-002, TC-036, TC-037)', () => {
  beforeAll(async () => {
