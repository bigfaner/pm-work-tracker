...
import { curl, apiBaseUrl, getApiToken, authHeader, parseApiBody, extractBizKey, randomCode, setupRbacFixtures } from '../../shared/helpers.js';
...
describe('RBAC — Roles (TC-039..TC-055)', () => {
  beforeAll(async () => {
