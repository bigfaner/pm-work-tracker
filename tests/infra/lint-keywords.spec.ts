...
describe('Lint Keywords Tests', () => {
  ...
  test.skipIf(!process.env.MYSQL_HOST)('TC-011: Fresh MySQL startup initializes RBAC with preset roles', () => {
