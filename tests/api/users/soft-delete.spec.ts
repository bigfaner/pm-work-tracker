...
import { curl, apiBaseUrl, randomCode, authHeader, getApiToken, parseApiBody, createTestUser, softDeleteUser, createTestTeam, createTestMainItem, createTestSubItem } from '../../shared/helpers.js';
...
describe('Soft-Delete — Users (TC-005, TC-006)', () => {
  beforeAll(async () => {
