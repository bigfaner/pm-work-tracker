...
import { BASE, API, login, getAuthToken, getFirstTeamId, loginAsUser, getTokenForUser, createUser, deleteUser, addUserToTeam, removeUserFromTeam, getRoleKey } from '../helpers.js';
...
test.describe('Team Detail - Page Load', () => {
  ...
  test.beforeEach(async ({ page }) => { await login(page, undefined, teamId ? `/teams/${teamId}` : '/items'); });
