  ...
  if (isLoading) {
    return (
      <div
        ...
        className="py-8 text-center text-tertiary text-sm"
      >
        加载中...
      </div>
    );
    ...
    <div data-testid="team-detail-page">
            ...
            <Button
              onClick={() =>
                changeRoleMutation.mutate({
                  memberId: roleEditTarget!.userKey,
                  roleKey: roleEditRoleId!,
                })
              }
              disabled={
                roleEditRoleId == null ||
                roleEditRoleId === roleEditTarget?.roleKey ||
      ...
      >
        <DialogContent size="sm">
          <DialogHeader>
            ...
            <DialogDescription>
              确认将「{transferTarget?.displayName}
              」设为PM？当前PM将变为普通成员。
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
              ...
              <div className="relative">
                ...
                {userDropdownOpen &&
                  ...
                  userSearchResults.length > 0 && (
                    <div
                      className="absolute z-50 mt-1 w-full max-h-48 overflow-auto rounded-md border border-border bg-white shadow-lg"
                      data-testid="invite-user-dropdown"
                    >
      ...
      >
        <DialogContent size="sm">
          ...
          <DialogFooter>
            <Button variant="secondary" onClick={() => setDisbandOpen(false)}>
              取消
            </Button>
            <Button
              variant="danger"
