...
export default function TeamManagementPage() {
  ...
  const inviteMutation = useMutation({
    mutationFn: () =>
      inviteMemberApi(addMemberTeamId!, {
    ...
    <div data-testid="team-management-page">
          ...
          <DialogBody>
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                />
                {codeError && (
                  <p className="mt-1 text-sm text-error">{codeError}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-primary mb-1">
      ...
      >
        <DialogContent size="md">
                ...
                {userDropdownOpen &&
                  ...
                  userSearchResults.length > 0 && (
                    <div
                      ...
                      data-testid="add-member-user-dropdown"
                    >
          ...
          <DialogFooter>
            <Button variant="secondary" onClick={closeAddMemberDialog}>
              取消
            </Button>
            <Button
