...
export default function UserManagementPage() {
  ...
  const [editForm, setEditForm] = useState<
    UpdateUserReq & { displayName: string; email: string }
  >({
    displayName: "",
    email: "",
  });
  ...
  const handleToggleStatus = useCallback(() => {
    ...
    const newStatus =
      statusUser.userStatus === "enabled" ? "disabled" : "enabled";
  ...
  const validatePassword = useCallback(
    (form: { newPassword: string; confirmPassword: string }) => {
              ...
              {users.map((user) => (
                <TableRow key={user.bizKey}>
                  ...
                  <TableCell>
                    <div className="flex flex-wrap gap-1">
                      {user.teams && user.teams.length > 0 ? (
                        user.teams.map((t) => (
                          <Badge key={t.bizKey} variant="primary">
                            {t.name}
                          </Badge>
                        ))
                      ) : (
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        user.userStatus === "enabled" ? "success" : "warning"
                      }
                    >
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {teams.map((t) => (
                      <SelectItem key={t.bizKey} value={t.bizKey}>
                        {t.name}
                      </SelectItem>
                    ))}
                  </SelectContent>
          ...
          <DialogBody>
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <Badge
                  variant={
                    statusUser?.userStatus === "enabled" ? "success" : "warning"
                  }
                >
              ...
              <div>
                ...
                <Badge
                  variant={
                    statusUser?.userStatus === "enabled" ? "warning" : "success"
                  }
                >
          ...
          <DialogBody>
            <div className="flex flex-col gap-4">
              <div className="rounded-lg bg-bg-alt px-3 py-2 text-sm text-secondary">
                ...
                姓名：
                <span className="text-primary">{resetUser?.displayName}</span>
              </div>
              <div>
                <label className="block text-sm font-medium text-primary mb-1">
