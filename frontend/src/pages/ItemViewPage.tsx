        ...
        <>
          ...
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            ...
            >
              <RefreshCw
                size={14}
                className={s.isFetching ? "animate-spin" : ""}
              />
              刷新
            </Button>
          </div>
          ...
          {s.isLoading ? (
            ...
            <ItemSummaryView
              ...
              onAddSubItem={(mainItemId, mainItemTitle) => {
                s.setCreateSubTarget(mainItemId);
                s.setCreateSubTargetName(mainItemTitle);
                s.setCreateSubOpen(true);
              }}
