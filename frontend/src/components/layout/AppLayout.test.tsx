    ...
    <MemoryRouter initialEntries={[initialPath]}>
      <Routes>
        <Route element={<AppLayout />}>
          <Route
            path="/items"
            element={<div data-testid="page-items">Items</div>}
          />
          <Route
            path="/weekly"
            element={<div data-testid="page-weekly">Weekly</div>}
          />
          <Route
            path="/teams"
            element={<div data-testid="page-teams">Teams</div>}
          />
          <Route
            path="/users"
            element={<div data-testid="page-users">Users</div>}
          />
        </Route>
        <Route
          path="/login"
          element={<div data-testid="page-login">Login</div>}
        />
      </Routes>
    </MemoryRouter>,
  );
